    ...
    return {
        init: function() {
            $(".mt-sweetalert").each(function() {
                ...
                $(this).click(function() { swal({ title: t, text: a, type: s, allowOutsideClick: e, showConfirmButton: n, showCancelButton: c, confirmButtonClass: p, cancelButtonClass: m, closeOnConfirm: o, closeOnCancel: i, confirmButtonText: l, cancelButtonText: u }, function(t) { t ? swal(h, d, "success") : swal(r, f, "error") }) })
            })
        }
    }
}();
