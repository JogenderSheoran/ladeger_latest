...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1" style="float:right;">
                                        <div class="btn-group fRight">
                                            <a href="{{route('addMedicine')}}" id="addShiftButton" class="btn sbold green add_button"> Add (F2)
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover order-column" id="mytable">
                                ...
                                <tbody id="ledger_body">
                                    ...
                                    <tr id="row{{$value->id}}">
                                        ...
                                        <td class="text-size">
                                        @if($value->primary==0)
                                            <a href="javascript:void(0)" id="showLedgerBtn" title="view medicine"  onclick="openPopup({{ $value->id }})"><i class="fa fa-eye" style="color:red;"></i></a>&nbsp;&nbsp;</a>&nbsp;&nbsp;
                                        @endif
                                        </td>
                                    </tr>
            ...
            <div class="popup" id="ledgerPopup">
        <div class="popup-header">
            <h4 id="ledger_name"><b>Ledger Name:</b></h4>
            <h4 id="total_amount"><b>Total Amount:</b></h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" autocomplete="off" name="grantor_name" id="grantor_name" 
                                                class="form-control input" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" autocomplete="off" name="mobile" id="mobile" 
                                                class="form-control input" />
                                        </div>
                                    </div>
...
function editShift(id) {
    ...
    $("#name").val(currentRow.find("td:eq(1)").text());
    $("#username").val(currentRow.find("td:eq(2)").text());
    $("#grantor_name").val(currentRow.find("td:eq(3)").text());
...
<script>
        function openPopup(ledger_id) {
            var ledger_id = ledger_id;
            $.ajax({
                    url: `${window.pageData.baseUrl}/api/get-medicine-transaction`,
                    method: 'POST',
                    data: {
                    ...
                    success: function(data) {
                        $('#ledger_name').text(`Ledger Name: ${data.ledgerName}`);
                        $("#total_amount").text(`Total Amount: ${data.totalAmount}`);
