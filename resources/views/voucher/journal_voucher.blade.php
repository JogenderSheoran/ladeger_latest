                                    ...
                                    <tbody class="text-effect" id="table_body">
                                        ...
                                        <tr id="row{{$value->id}}" @if($value->transaction_status==1) style="background-color:rgb(150 221 150)" @endif>
                                            ...
                                            <td class="text-effect">
                                                ...
                                                @if($value->medicine_transaction_type=='minus')lene @else dene @endif
                                                </span>
                                                @endif
                    ...
                    if (data.status == 'success') {
                        $.each(data.data, function (k, data) {
                            ...
                            if(data['transaction_status']===1){
                                var t_status='<input  checked  type="checkbox" id="t'+data['id']+'" class="form-control" style="height:15px;" onclick="change_status('+data['id']+')" >';
                            }
                            else{
                                var t_status='<input    type="checkbox" id="t'+data['id']+'" class="form-control" style="height:15px;" onclick="change_status('+data['id']+')" >';
                            }
                            ...
                            var row='<tr id="row'+data['id']+'"><td class="text-effect">'+data['id']+'</td><td class="text-effect">'+data['date']+'</td><td class="text-effect">'+data['ledger_name']+'</td><td></td><td class="text-effect">'+cr_dr+'</td> <td class="text-effect">'+data['amount']+'</td><td></td><td class="text-effect">'+remark+'</td><td>'+t_status+'</td><td>'+data['opening_balance']+'</td><td>'+data['closing_balance']+'</td>'
                            +'</tr>';
