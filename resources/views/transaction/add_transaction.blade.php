                    ...
                    <div class="col-md-12">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-title" style="min-height: 40px;">
                                <div class="tools"> </div>
                                <div class="btn-group">
                                    <select class="form-control select2" id="party"  required>
                                        <option value="" selected disable>Select Party</option>
                                        @foreach($ledgers as $ledger)
                                            <option value="{{$ledger->id}}">{{$ledger->name." ".$ledger->dara."/".$ledger->dara_commission}}</option>
                                        @endforeach
                                    </select>                                
                                </div>   

                                <div class="btn-group">
                                    <a  href="javascript:;" id="rate" class="btn green"> Rate: 0/0-0/0 </a>
                                </div>
                                <div class="btn-group">
                                    <a  href="javascript:;" id="limit" class="btn btn-success"> Limit: 0 </a>
                                </div>
                                <div class="btn-group">
                                    ...
                                    <div class="col-md-3 normal_view">
                                        <div class="row form-group">
                                            <div class="col-md-5" style="padding-left:5px;padding-right:5px;">
                                                <input type="text" onkeyup onkeypress="return isNumberKey(event)" maxlength="4" placeholder="Number" class="form-control number number1" id="number1"/> 
                                            </div>
                                            <div class="col-md-5" style="padding-left:5px;padding-right:5px;">
                                                <input type="text" onkeyup onkeypress="return isNumberKey(event)" maxlength="4" placeholder="Amount" class="form-control amount amount1" id="amount1"/> 
                                            </div>
...
<script>
    ...
    $("#save").click(function(){
        ...
        $.ajax({		            	
            ...
            data: {shift:{{$shift->id}},total:$("#total_amount").val(),amount:amounts,number:numbers,party:$('#party').val(),user:{{Auth::User()->id}},DaraTotal:$('#JantriDaraTotal').text(),AkharTotal:parseFloat($('#JantriBaharTotal').text())+parseFloat($('#JantriAndarTotal').text())},                                     
            beforeSend: function(){
                $("#save").hide(); 
                $("#wait").show();
            },
